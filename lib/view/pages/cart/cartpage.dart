                                                ...
                                                onTap: () {
                                                  var popularindex = Get.find<
                                                      ...
                                                      .indexOf(_cartlist[index]
                                                          .product!);
                                                  if (popularindex >= 0) {
                                                    Get.toNamed(routeheleper
                                                        .getPopularFood(
                                                      popularindex,
                                                    ));
                                                  } else {
                                                    var recomandedindex = Get.find<
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            List<Map> cartitems = [];
                            List<Map<String, dynamic>> ordersTodatabase = [];
                            ...
                            cart.forEach((element) {
                              ...
                              //! snaaet liste okhra fi wasetha des maps  besh naabathha ll base de donnes
                              //!kol map fiha el deatils kol mtaa kol hejet shrythe
                              ordersTodatabase.add({
                                "id": element.id,
                                "name": element.name,
                                "price": element.price,
                                "img": element.img,
                                ...
                                "time": DateTime.now(),
                                "latitude": shared.getlatutide("latutide"),
                                "longitude": shared.getlong("longitude"),
                                "place": Get.find<locationcontroller>()
                                        .addresstypelist[
                                    Get.find<locationcontroller>()
                                        .addrestypeindex],
                                "street": shared.getString("address"),
                                "product": element.product!.toJson()
                              });
                            });
                            ...
                            if (shared.getbool("islogin") == true &&
                              ...
                              Stripe.StripePaymentCheckout(
                                ...
                                //! besh naaml variable el foug esmha is loading ken
                                //!is loding true reho besh yben circleprogresindicator w ebesh tbdl false baaed ma naal enreg fi base de donnees
                                //! lel items eli shrythom baed ma tkml el enregistrement fi base
                                //! besh yrajaa is loading fasle w yhezni ll page mtaa confirmation

                                await database(
                                        Uid: FirebaseAuth
                                            .instance.currentUser!.uid)
                                    .saveorder(ordersTodatabase)
                                    .then((value) {
                            ...
                            else if (shared.getbool("islogin") == true &&
                                shared.getaddressexiste("addressexiste") ==
                                    false) {
